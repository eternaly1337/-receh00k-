...
local library = {
	design = getgenv().design == "kali" and "kali" or "$receh00k$",
	tabs = {},
	draggable = true,
	flags = {},
	title = "$receh00k$ |" .. " " .. version,
	open = false,
...
local GameTitle = ""
local GameList = {
	["Criminality"] = 10716783997, 11353105682
}
...
MiscMain:AddButton({
	...
	callback = function()
		setclipboard("https://discord.gg/R5k83cum")
	end
})
if syn then
	MiscMain:AddSlider({
		...
		TeleportationSection:AddButton({
			...
			callback = function()
				if library and library.flags.Teleportation == "Tower" then
					Teleport(Vector3.new(- 406.359, 160.081, 374.2907))
				elseif library and library.flags.Teleportation == "?" then
					Teleport(Vector3.new(- 12.5217, 5.9658, 186.8333))
				elseif library and library.flags.Teleportation == "Gas Station" then
					Teleport(Vector3.new(- 245.77, 7.179, 180.773))
				end
			end,
		})
